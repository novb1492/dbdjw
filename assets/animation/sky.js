export default class Sky {
  ...
  draw(nowminuit, totalminuit) {
    this.s.background(this.s.map(nowminuit, 0, totalminuit, this.sr, this.er), this.s.map(nowminuit, 0, totalminuit, this.sg, this.eg), this.s.map(nowminuit, 0, totalminuit, this.sb, this.eb));
  }
}